...
<body>
  ...
  <div className="logoImage" style="text-align: center;">
    <img
      src="{{imageUrl}}" alt="logo" style="height: 60px; width: 100%; object-fit: contain; margin-bottom: 1rem;"
    />
  </div>
  <div>
    <div
      className="contect"
      style="margin:auto; border:1px solid #F5F5F5; background-color:#f5f5f5; color:#000000; padding: 2rem;"
    >
      <div>
      ...
      <div style="font-size:14px; text-align: left;">
        ...
        <img src={{gpsScreenshot}} style="display:block; margin:auto; height: 400px; object-fit: contain;" alt="GPS Screensort">
        <p>
          This email is sent by Callahead to keep you informed about your
          Callahead servicing status. Have questions? Please do not reply to
          this service email. Instead, just contact us at: info@callahead.com or
          call 800.634.2085.
        </p>

        <p>
          If you no longer wish to receive Callahead Service email
          notifications, 
